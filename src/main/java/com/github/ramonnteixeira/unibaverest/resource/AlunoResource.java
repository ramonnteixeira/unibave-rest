...
@Api(value = "Cadastro de Alunos", tags = "alunos", consumes = MediaType.APPLICATION_JSON, produces = MediaType.APPLICATION_JSON)
@Path("/alunos")
...
public interface AlunoResource {
    ...
    @ApiResponses(value = { @ApiResponse(code = 200, message = "Aluno atualizado com sucesso", response = Aluno.class),
    ...
    @ApiResponses(value = { @ApiResponse(code = 204, message = "Aluno deletado com sucesso"),
            @ApiResponse(code = 404, message = "Aluno não encontrado") })
    @DELETE
    @Path(value = "{codigo}")
    ...
    @ApiResponses(value = { @ApiResponse(code = 200, message = "Aluno retornado com sucesso", response = Aluno.class),
            @ApiResponse(code = 404, message = "Aluno não encontrado") })
    @GET
    @Path(value = "{codigo}")
